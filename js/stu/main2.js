...
$(document).ready(function () {
    ...
    if (token) {
        ...
        $('#image_selector').change(() => {
            changeFile($('#image_selector'), 0);
        });
        $('#video_selector').change(() => {
            changeFile($('#image_selector'), 1);
        });
        $('#music_selector').change(() => {
            changeFile($('#image_selector'), 2);
        });
        $('#save-work').click(() => {
    ...
    function changeFile(element, type) {
        new_work_type = type;
    ...
    function updateNewWork(work, index) {
        ...
        $('.show-container').append(`<div class="work-content">
            <div class="work-file">
                ${show_element}
            </div>
